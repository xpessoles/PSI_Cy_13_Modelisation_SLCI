...
\marginnote{\textit{Indications : il y a 3 blocs dans la chaîne directe et un seul dans la chaîne de retour; l'entrée du schéma est $U_m(p)$, la sortie est $\Omega_m(p)$.}}\question{Réaliser le schéma bloc du moteur.Le moteur à courant continu seul est-il asservi ? Pourquoi ?}
\ifprof
\begin{corrige}
