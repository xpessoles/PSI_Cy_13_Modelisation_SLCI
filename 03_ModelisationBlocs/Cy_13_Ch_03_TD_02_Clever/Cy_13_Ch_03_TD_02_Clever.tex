...
$K_a$ et $K_c$ pour que l'écart soit nul lorsque l'angle de l'habitacle est égale à l'angl de consigne ? Proposer  nom de capteur. 
\end{question}
\ifprof
\begin{corrige}
On a $\varepsilon(t) = K_a \alpha_c(t) - K_c \alpha(t)$. 

Pour que $\varepsilon(t)$ soit nul lorsque $\alpha_c(t) =  \alpha(t)$, il faut que 
$K_a = K_c$.
...
Par ailleurs, 
$\lim\limits_{t\to  +\infty}  \alpha(t) = \lim\limits_{p\to  0}  p  \alpha(p) $ 
$= \lim\limits_{p\to  0}  p  \dfrac{1}{p} \dfrac{1}{\dfrac{S}{CRK_S K}p+1} = 1$
...
$= \lim\limits_{p\to  0}  p  \dfrac{1}{p^2} \dfrac{1}{\dfrac{S}{CRK_S K}p+1} $
$= \lim\limits_{p\to  0}   \dfrac{1}{p} \dfrac{1}{\dfrac{S}{CRK_S K}p+1}  = +\infty$
...
\begin{marginfigure}
\begin{center}
\includegraphics[width=3cm]{Cy_13_Ch_03_TD_02_Clever_qr}
\end{center}
\end{marginfigure}
\fi
